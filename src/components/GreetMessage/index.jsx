...
const GreetMessage = ({ closeGreetMessage }) => {
  console.log("🚀 ~ GreetMessage ~ closeGreetMessage", closeGreetMessage);
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
        ...
        <div className="greet-message top-48 relative z-50">
          <div className="px-10 py-8 w-6/12 rounded-2xl bg-white">
            ...
            <div className="text-center thanksContent space-y-5">
              ...
              <p className="text-md">
                We received your message and we will try to contact you as soon
                as possible.
              </p>
              <button
