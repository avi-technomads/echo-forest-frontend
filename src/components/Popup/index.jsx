...
const Popup = ({ setOpenModal }) => {
  ...
  useEffect(() => {
    const checkIfClickedOutside = (e) => {
      ...
      // then close the menu
      if (setOpenModal && ref.current && !ref.current.contains(e.target)) {
        setOpenModal(false);
      }
    };
    ...
    <>
      ...
      >
        <div className="container mx-auto contents my-20">
          {/* <div className="popup"> */}
          <div className="popup  rounded-3xl example">
            <div className="grid grid-cols-1 xl:grid-cols-2  ">
              {/* <div className="flex flex-wrap flex-col"> */}
              <div className="leftBox flex flex-col bg-[#e7f5e4] justify-between py-7 px-6 lg:px-15 ">
                <div className="intro">
