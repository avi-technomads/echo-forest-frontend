...
function Footer() {
  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-32 items-center px-5">
        <div className="border-[1px] border-black mb-14 " />
        <div className="flex flex-col md:flex-row justify-around md:items-baseline items-center gap-7">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 text-xl">
              <a
                href="https://discord.gg/GE3EMfQkJF"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://twitter.com/EchoForestNFT"
                target="_blank"
                rel="noreferrer"
              >
